...
class Config:
    ...
    METHOD_DOC_TEMPLATE_PATH = (
            os.environ.get('DOCX_TEMPLATE_MOUNT_PATH') or
            os.environ.get('DOCX_TEMPLATE_PATH')
    )
    ...
    BUSINESS_LOGIC = {
        ...
        "ORG_FILES_DIR": os.environ.get('ORG_FILES_MOUNT_PATH') or
                         os.environ.get('ORG_FILES_PATH', '/tmp/'),
        "METHOD_DOCS_PATH":
            os.environ.get('METHOD_DOCS_MOUNT_PATH') or
            os.environ.get('METHOD_DOCS_PATH', '/tmp/'),
