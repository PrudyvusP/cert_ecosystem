    ...
    def get_dative_last_name(self):
        if self.gender == 'мужской':
            if re.search(r'\b\w+я\b', self.last_name):
                ...
                name = super().lastname(self.last_name, Case.DATIVE, Gender.MALE)
            return name
...
if __name__ == '__main__':
    ...
    test_data_male = {'иванов иван иванович': ('И.И. Иванову', 'Иван Иванович'),
                      ...
                      'Чеснаускис Ростов Капралович': ('Р.К. Чеснаускису', 'Ростов Капралович'),
                      'Жук Жуков Жукович': ('Ж.Ж. Жуку', 'Жуков Жукович')}

    test_data_female = {'глушко ирина андреевна': ('И.А. Глушко', 'Ирина Андреевна'),
                        'Колыма Анна Геннадьевна': ('А.Г. Колыма', 'Анна Геннадьевна'),
                        'Яркая Личность Константиновна': ('Л.К. Яркой', 'Личность Константиновна'),
                        'Тестова Ирина Лжедмитриевна': ('И.Л. Тестовой', 'Ирина Лжедмитриевна'),
