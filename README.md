...
* У ИР могут быть сфера(-ы) функционирования (Industry), задаваемые [законодательством](http://publication.pravo.gov.ru/Document/View/0001201707260023).
* *Одна организация может передавать другой Организации собственные ИР на аутсорс в части мониторинга информационной безопасности.* - # TODO
